    ...
    $.ajax({
        ...
        success: function (m) {
            ...
            for (i = 0; i < ml; i++) {
                ...
                str += "<td><a href='javascript:void(0);' class='edit'>修改</a></td>";
                str += "<td>" + m['tz'][i]['gid'] + "</td>";
                str += "<td>" + m['tz'][i]['qishu'] + "</td>";
                str += "<td>" + m['tz'][i]['tid'] + "</td>";
                str += "<td>" + setzt(m['tz'][i]['zt']) + "</td>";
            ...
            $(".nowtb").prepend("<tr><td colspan=2><a href='javascript:void(0)' class='editall' >修改选中</a></td><td colspan=38>" + m['page'] + "</td></tr>");
            $(".nowtb").append(str);
...
function setzt(v) {
    return v;
    var str = "<select class='zt' >";
    str += "<option value='1' ";
    if (Number(v) == 1) str += "selected";
    str += ">正常</option><option value='0' ";
    if (Number(v) == 0) str += "selected";
    str += " >无效</option>";
    str += "</select>";
    return str;
}
